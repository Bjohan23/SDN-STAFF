...
const RoleManagement = () => {
  ...
  const roleIconMap = {
    ...
    Usuario: (
      <svg className="h-4 w-4 mr-2 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const roleColorMap = {
    ...
    Editor: "bg-blue-900 text-blue-200 border-blue-600",
    Usuario: "bg-gray-500 text-gray-100 border-gray-400",
                ...
                {editingUserId === u.id_usuario && (
                  <div className="mt-6 pl-16">
                    <div className="bg-gray-600 rounded-lg p-4">
                      ...
                      {rolesBackend.length === 0 ? (
                        <div className="text-yellow-300 text-sm font-semibold">No hay roles disponibles en el sistema. Debes crear roles primero.</div>
                      ) : (
