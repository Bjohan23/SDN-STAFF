module.exports = (sequelize, DataTypes) => {
  const LogValidacion = sequelize.define('LogValidacion', {
  id_log: {
...
// Métodos estáticos
LogValidacion.getEstadisticasPorEvento = async function(idEvento, fechaInicio = null, fechaFin = null) {
...
LogValidacion.getValidacionesSospechosas = async function(idEvento = null, limite = 50) {
  const where = {
