module.exports = (sequelize, DataTypes) => {
  const AccesoEvento = sequelize.define('AccesoEvento', {
  id_acceso: {
...
AccesoEvento.prototype.esValidoAhora = function() {
  ...
  if (this.fecha_inicio_acceso && ahora < this.fecha_inicio_acceso) return false;
  ...
  if (this.limite_usos_totales && this.usos_realizados >= this.limite_usos_totales) return false;
