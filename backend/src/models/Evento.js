...
module.exports = (sequelize, DataTypes) => {
  const Evento = sequelize.define('Evento', {
    ...
    estado: {
      type: DataTypes.ENUM('borrador', 'publicado', 'activo', 'finalizado', 'archivado'),
      defaultValue: 'borrador',
      validate: {
        isIn: {
          args: [['borrador', 'publicado', 'activo', 'finalizado', 'archivado']],
  ...
  Evento.prototype.isActive = function() {
    const now = new Date();
    return this.fecha_inicio <= now && this.fecha_fin >= now && this.estado === 'activo';
  };
